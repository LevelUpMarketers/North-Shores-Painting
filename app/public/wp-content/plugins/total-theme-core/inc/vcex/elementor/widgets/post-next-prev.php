...
use VCEX_Post_Next_Prev_Shortcode as Shortcode;
...
class Post_Next_Prev extends Widget_Base {

	public function get_name() {
		return 'vcex_post_next_prev';
	}
	...
	public function get_keywords() {
		return [ 'post', 'navigation', 'next', 'prev', 'previous' ];
	}
